...
const Layout = () => {
  ...
  const routeConfig = {
    ...
    "/admin-eliminar-user": {
      title: "Panel De Eliminacion De Usuarios",
      showVenta: true,
      showPregunta: true,
      showRegistro: false,
      showLogin: false,
    ...
    "/admin-gastos": {
      title: "Panel De Administracion Gastos Comunes",
      showVenta: true,
      showPregunta: true,
      showRegistro: false,
      showLogin: false,
    ...
    "/admin-eliminar-post": {
      title: "Panel De Eliminacion De Post",
      showVenta: true,
      showPregunta: true,
      showRegistro: false,
      showLogin: false,
    ...
    "/admin-eliminar-venta": {
      title: "Panel De Eliminacion De Ventas",
      showVenta: true,
      showPregunta: true,
      showRegistro: false,
      showLogin: false,
